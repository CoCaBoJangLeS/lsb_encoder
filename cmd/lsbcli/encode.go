...
// 		SrcFile:   command.Flags().GetString("srcfile"),
// 		OutputDir: command.Flags().GetString("outdir"),
// 		Text: command.Flags().GetString("text"),
// 		MessageFile: command.Flags().GetString("infile")
// 	}
// }
